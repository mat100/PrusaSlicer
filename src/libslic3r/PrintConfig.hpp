...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionBool,                tool_ordering_optimization))
    ((ConfigOptionBool,                enable_predictive_nozzle_temperature))
    ((ConfigOptionFloat,               predictive_temp_hysteresis))
    ((ConfigOptionFloats,              nozzle_heating_speed))
    ((ConfigOptionFloats,              nozzle_cooling_speed))
    ((ConfigOptionFloats,              filament_heat_transfer_coeff))
    ((ConfigOptionInts,                filament_temp_clamp_min))
    ((ConfigOptionInts,                filament_temp_clamp_max))
    ((ConfigOptionInts,                filament_temp_offset_bridge))
    ((ConfigOptionInts,                filament_temp_offset_overhang))
    ((ConfigOptionInts,                filament_temp_offset_external_perimeter))
    ((ConfigOptionInts,                filament_temp_offset_infill))
